  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md border border-[#dbaf2c]">
        ...
        <button type="submit" className="w-full bg-[#70992f] text-white py-3 rounded font-semibold hover:bg-[#55731f] transition" disabled={loading}>{loading ? "Logging in..." : "Login"}</button>
